...
RL Enviroments | Growing into AI
...
Working on infrastructure and environments for AI agents. I enjoy building across the stack — from frontend interfaces and developer tooling to backend systems and scalable architectures.

Interested in reinforcement learning environments, LLMs, agent frameworks, and practical AI systems that interact with complex workflows and dynamic environments.
...
- Building full-stack systems and infrastructure for AI-driven applications
- Exploring RL environments, LLMs, agent architectures, and practical AI workflows
- Contributing to projects and tools I genuinely find useful
